package org.tang.springjavafxm1.config.mybatis;
...
public class MapperAspect {
	...
	@AfterReturning("execution(* org.tang.springjavafxm1.mapper..*Mapper.*(..))")
	 ...
	 */
	@Pointcut("execution(* org.tang.springjavafxm1.mapper..*Mapper.*(..))")
